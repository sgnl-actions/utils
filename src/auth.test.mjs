...
describe("Auth Utilities", () => {
  ...
  describe("getClientCredentialsToken", () => {
    ...
    test("should throw error on failed token request", async () => {
      ...
      await expect(getClientCredentialsToken(validConfig)).rejects.toThrow(
    ...
    test("should throw error when response has no access_token", async () => {
      ...
      await expect(getClientCredentialsToken(validConfig)).rejects.toThrow("No access_token in OAuth2 response");
    });
  });
  ...
  describe("getAuthorizationHeader", () => {
    ...
    test("should throw error when OAuth2 Client Credentials missing TOKEN_URL", async () => {
      ...
      await expect(getAuthorizationHeader(context)).rejects.toThrow(
  ...
  describe("getBaseURL", () => {
    ...
    test("should throw error when no URL available", () => {
      ...
      expect(() => getBaseURL(params, context)).toThrow(
